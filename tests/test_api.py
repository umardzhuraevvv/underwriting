...
class TestAnketaCRUD:
    ...
    def test_get_anketa(self, client, admin_headers, seeded_db):
        ...
        resp = client.get(f"/api/v1/anketas/{anketa_id}", headers=admin_headers)
    ...
    def test_list_anketas(self, client, admin_headers, seeded_db):
        # Создаём анкету
        client.post("/api/v1/anketas?client_type=individual", headers=admin_headers)

        resp = client.get("/api/v1/anketas", headers=admin_headers)
    ...
    def test_delete_anketa(self, client, admin_headers, seeded_db):
        ...
        get_resp = client.get(f"/api/v1/anketas/{anketa_id}", headers=admin_headers)
        data = get_resp.json()
...
class TestPublicAccess:
    ...
    def test_public_anketa(self, client, admin_headers, sample_anketa_data, seeded_db):
        ...
        detail = client.get(f"/api/v1/anketas/{anketa_id}", headers=admin_headers).json()
        ...
        resp = client.get(f"/api/v1/public/anketa/{token}")
    ...
    def test_public_anketa_invalid_token(self, client, seeded_db):
        resp = client.get("/api/v1/public/anketa/invalid_random_token_12345")
