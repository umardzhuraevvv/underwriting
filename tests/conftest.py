...
def _seed_rules(db_session):
    ...
    default_rules = [
        ...
        {"category": "overdue", "rule_key": "overdue_31_60_gt_far_pv_add", "value": "5", "label": "31-60, > дальн.: ПВ +%", "value_type": "float"},
        ...
        {"category": "overdue", "rule_key": "overdue_61_90_gt_result", "value": "review", "label": "61-90, > порога: решение", "value_type": "string"},
...
def default_rules():
    ...
    return {
        ...
        "overdue_61_90_gt_result": "review",
