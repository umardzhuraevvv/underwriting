...
## Критерий готовности
- [x] Модель WebhookConfig создана
- [x] Alembic миграция сгенерирована
- [x] Webhook отправляется при conclude
- [x] HMAC подпись работает
- [x] CRUD API для управления webhooks
- [x] Тесты зелёные (14 новых тестов, 77 всего)
